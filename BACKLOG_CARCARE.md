...
### Epic 1: База знаний для AI ✅
- **User Story:** Как пользователь, я хочу через чат спрашивать о работе с приложением и получать ответы на основе документации.
  - **Acceptance Criteria:**
    - Создан AGENTS.md с описанием проекта
    - Создана пользовательская документация в docs/
    - Создан AI-навык /carcare-help для консультаций
  - **Статус:** ✅ Выполнено (ветка feature/ai-agent-docs)

### Epic 2: Создание сущностей через чат ✅
- **User Story:** Как пользователь, я хочу описывать текстом что создать (автомобиль, заправку, ТО, штраф), а AI-агент собирал данные и задавал уточняющие вопросы.
  - **Acceptance Criteria:**
    - AI понимает тип сущности из текста
    - Извлекает поля и проверяет валидность
    - Запрашивает недостающие данные
    - Выдаёт готовую структуру
  - **Статус:** ✅ Выполнено (ветка feature/ai-agent-docs)

### Epic 3: Распознавание чеков и квитанций
- **User Story:** Как пользователь, я хочу сфотографировать чек или квитанцию, а AI-агент распознает текст и создаст сущность (ТО, штраф).
  - **Acceptance Criteria:**
    - Загрузка изображения чека/квитанции
    - OCR-распознавание текста
    - Извлечение данных и создание сущности
