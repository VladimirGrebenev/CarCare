...
1. **Откройте приложение** — появится welcome-экран с описанием возможностей.
...
5. **Проверьте профиль** — заполните имя, добавьте авто, загрузите фото.

> После регистрации вы можете:
> - Добавить автомобиль
> - Изучить разделы: Топливо, ТО, Штрафы, Отчёты
> - Настроить виджеты на главной
